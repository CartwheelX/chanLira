encoder_op_list_name_dict = {
  "6x5_ryrz_linear_cnot": [
    ...
    {"input_idx": [6], "func": "rz", "wires": [0]},
    {"input_idx": [7], "func": "rz", "wires": [1]},
    {"input_idx": [8], "func": "rz", "wires": [2]},
    {"input_idx": [9], "func": "rz", "wires": [3]},
    {"input_idx": [10], "func": "rz", "wires": [4]},
    {"input_idx": [11], "func": "rz", "wires": [5]},
    {"input_idx": None, "func": "cx", "wires": [0, 1]},
    {"input_idx": None, "func": "cx", "wires": [1, 2]},
    {"input_idx": None, "func": "cx", "wires": [2, 3]},
    {"input_idx": None, "func": "cx", "wires": [3, 4]},
    {"input_idx": None, "func": "cx", "wires": [4, 5]},
    ...
    {"input_idx": [1], "func": "ry", "wires": [5]},
    {"input_idx": [2], "func": "rz", "wires": [0]},
    {"input_idx": [3], "func": "rz", "wires": [1]},
    {"input_idx": [4], "func": "rz", "wires": [2]},
    {"input_idx": [5], "func": "rz", "wires": [3]},
    {"input_idx": [6], "func": "rz", "wires": [4]},
    {"input_idx": [7], "func": "rz", "wires": [5]},
    {"input_idx": None, "func": "cx", "wires": [0, 1]},
    {"input_idx": None, "func": "cx", "wires": [1, 2]},
    {"input_idx": None, "func": "cx", "wires": [2, 3]},
    {"input_idx": None, "func": "cx", "wires": [3, 4]},
    ...
    {"input_idx": [0], "func": "rz", "wires": [2]},
    {"input_idx": [1], "func": "rz", "wires": [3]},
    {"input_idx": [2], "func": "rz", "wires": [4]},
    {"input_idx": [3], "func": "rz", "wires": [5]},
    {"input_idx": None, "func": "cx", "wires": [0, 1]},
    {"input_idx": None, "func": "cx", "wires": [1, 2]},
    {"input_idx": None, "func": "cx", "wires": [2, 3]},
    {"input_idx": None, "func": "cx", "wires": [3, 4]},
    ...
    {"input_idx": [8], "func": "ry", "wires": [4]},
    {"input_idx": [9], "func": "ry", "wires": [5]},
